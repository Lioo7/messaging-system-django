...
class MessageAPITests(TestCase):
    def setUp(self):
        ...
        self.user_c = User.objects.create_user(username='badactor1', password='badactor1pass')
        self.user_d = User.objects.create_user(username='badactor2', password='badactor2pass')
        ...
        message4 = Message.objects.create(sender=self.user_c, receiver=self.user_d, subject='Test Subject 4', content='Test Content 4')
